...
@section('title', 'Calculadora de Indemnización y Liquidación LFT ' . now()->year . ' – México')
@section('meta_description', 'Calculadora gratuita para estimar indemnización por despido injustificado o liquidación/finiquito conforme a la Ley Federal del Trabajo en México. Usa SD/SDI, antigüedad y fechas. Desglose detallado y base legal actualizada.')
...
<div class="space-y-10">
  ...
  <section class="rounded-3xl bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-white shadow">
    <h2 class="text-3xl font-semibold">Calculadora de indemnización y liquidación en México (LFT) {{ now()->year }}</h2>
    ...
    <nav class="mt-3 text-sm text-blue-100 flex flex-wrap gap-4" role="navigation" aria-label="Contenido de la página">
      ...
      <a href="#que-es-liquidacion" class="underline">¿Qué incluye la liquidación?</a>
  ...
  {{-- Elección del tipo de cálculo: usa fieldset/legend para semántica --}}
      ...
      <div class="flex items-start gap-3">
        ...
        <div class="space-y-1">
          ...
          <p class="text-sm text-gray-600">
            ...
            o <strong>no te reinstalan</strong> tras un conflicto. <em>No aplica si renunciaste.</em>
          </p>
          <p class="text-sm text-gray-600">
  ...
  {{-- Formulario --}}
  <form id="calc-form" method="POST" action="{{ route('calculate') }}" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    @csrf
    ...
    <section class="lg:col-span-2 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div>
          ...
          <p id="sd_help" class="text-xs text-gray-500 mt-1">Recibo de nómina: “salario diario”. Si solo tienes sueldo: mensual ÷ 30, quincenal ÷ 15, semanal ÷ 7.</p>
        </div>
        ...
        <div>
          ...
          <p id="sdi_help" class="text-xs text-gray-500 mt-1">Suele mostrarse en portal de nómina o visor del IMSS. Si no lo tienes, usamos SD.</p>
        </div>
        ...
        <div>
          ...
          <details class="mt-1 text-xs text-gray-500">
            ...
            Municipios de la franja fronteriza (BC, Sonora, Chihuahua, Coahuila, Nuevo León, Tamaulipas). Si dudas, elige “General”.
          </details>
        </div>
      ...
      <div class="mt-6 flex items-center justify-between gap-3">
        ...
        <button class="px-5 py-2.5 rounded-xl bg-blue-600 text-white font-medium shadow hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
          Calcular
        </button>
      </div>
    </section>
...
{{-- JSON-LD extra (WebPage + BreadcrumbList) --}}
@push('head')
  @php
    $webPageLd = [
      '@context' => 'https://schema.org',
      '@type' => 'WebPage',
      'name' => 'Calculadora de indemnización y liquidación (LFT México)',
      'url' => url()->current(),
    ...
    $breadcrumbsLd = [
      ...
      'itemListElement' => [
        ...
        ['@type'=>'ListItem','position'=>2,'name'=>'Calculadoras laborales','item'=>url()->current()],
      ],
    ];
  @endphp
