      ...
      <div class="flex items-start gap-3">
        ...
        <div class="space-y-1">
          ...
          <p class="text-sm text-gray-600">
            Aplica cuando <strong>te despiden sin causa</strong>, hay <strong>rescisión imputable al patrón</strong> o
  ...
  <form id="calc-form" method="POST" action="{{ route('calculate') }}" class="grid grid-cols-1 lg:grid-cols-3 gap-6" aria-label="Formulario de cálculo">
    ...
    <section class="lg:col-span-2 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <section id="supuestos">
        <h3 class="text-lg font-semibold mb-3">Supuestos del cálculo</h3>
        <p class="text-xs text-gray-500 mb-4">
          En <strong>Finiquito</strong> se ocultan los campos exclusivos de <strong>Indemnización</strong> (no aplican por ley).
        </p>
...
(function() {
  ...
  function toggleByType(type) {
    ...
    // Además: en FINIQUITO, asegurar que inputs exclusivos de indemnización no viajen
    if (type === 'liquidacion') {
